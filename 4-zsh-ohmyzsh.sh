...
then
	echo -e "${AZUL}Arquivo .zshrc encontrado${FIM}"
	echo -e "${AZUL}Instalando Oh my Zsh, plugins e Powerlevel10K${FIM}"
	...
	echo -e "${AZUL}Arquivo .zshrc não encontrado na pasta home. Leia as intruções de instalação. Fim${FIM}"
fi 
